...
const PokemonCard = (props) => {
  ...
  return (
    <PokeCard>
      ...
      <ContainerButton>
        {existPokemon ? (
          <ButtonRemovePokemon onClick={() => removePokemon(props.pokemon)}>
            Remover
          </ButtonRemovePokemon>
        ) : (
          <ButtonAddPokemon onClick={() => addPokemon(props.pokemon)}>
            Adicionar
          </ButtonAddPokemon>
        )}
        <ButtonDetailPokemon
          onClick={() => goToPokemonDetailPage(history, props.pokemon.name)}
        >
          Ver Detalhes
        </ButtonDetailPokemon>
      </ContainerButton>
